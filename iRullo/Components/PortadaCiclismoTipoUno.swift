...
struct PortadaCiclismoTipoUno: View {
    
    @ObservedObject var imageLoader = ImageLoader()
    
    let contentData: PortadaCiclismoModel?
    ...
    init(contentData: PortadaCiclismoModel?, urlwebView: URL? = nil) {
